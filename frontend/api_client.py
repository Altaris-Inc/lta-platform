...
class LTAClient:
    ...
    def suggest_field(self, tape_id: str, field_key: str) -> dict:
        ...
        return self._request("GET", f"/api/tapes/{tape_id}/suggest/{field_key}", timeout=120)
    ...
    def get_dq(self, tape_id: str, csv_bytes: bytes = None, filename: str = "tape.csv") -> dict:
        """
        Run DQ checks. Tries GET (cache) first, falls back to POST with CSV bytes.
        """
